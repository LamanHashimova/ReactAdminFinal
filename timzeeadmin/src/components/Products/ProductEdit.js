...
function ProductEdit(props) {
  ...
  //   const response = axios.get(`https://localhost:44330/api/Products/GetProduct/${id}`)
  ...
  const loadCategory = async () => {
    const resultcategory = await axios.get("https://localhost:44330/api/Categories/GetAllCategories");
    setCategories(resultcategory.data);
  }

  const loadBrand = async () => {
    const resultbrands = await axios.get("https://localhost:44330/api/Brands/GetAllBrands");
  ...
  async function update(e) {
    ...
    await axios.put(`https://localhost:44330/api/Products/UpdateProduct/${id}`,
      bodyParameters

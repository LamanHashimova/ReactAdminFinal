...
function ProductTable() {
    ...
    const loadProduct = async () => {
        ...
        const result = await axios.get(`https://timzeeback.azurewebsites.net/api/Products/GetAllProducts`)
        console.log(result);
    ...
    debugger
        await axios.delete(`https://timzeeback.azurewebsites.net/api/Products/${id}`)

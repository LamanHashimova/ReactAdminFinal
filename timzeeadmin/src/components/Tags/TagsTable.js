...
function TagsTable() {
    ...
    const loadTag = async () => {
        ...
        const result = await axios.get(`https://timzeeback.azurewebsites.net/api/Tags/GetAllTags`)
        setTags(result.data);
    ...
    debugger
        await axios.delete(`https://timzeeback.azurewebsites.net/api/Tags/DeleteTag/${id}`)

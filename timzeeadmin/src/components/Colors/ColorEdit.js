...
function ColorEdit(props) {
    ...
    function initPromise() {
      const response = axios.get(`https://timzeeback.azurewebsites.net/api/Colors/GetColor/${id}`)
    ...
    async function update(e) {
      ...
      await axios.put(`https://timzeeback.azurewebsites.net/api/Colors/UpdateColor/${id}`,
        bodyParameters,
        // config
      )

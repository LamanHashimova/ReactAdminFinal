...
function TeamTable() {
    ...
    const loadTeam = async () => {
        ...
        const result = await axios.get(`https://timzeeback.azurewebsites.net/api/Teams/GetAllTeams`)
        console.log(result);
    ...
    const deleteTeam = async (id) => {
        ...
        await axios.delete(`https://timzeeback.azurewebsites.net/api/Teams/DeleteTeam/${id}`)

  ...
  function ProductColorEdit(props) {
    ...
    const loadColors = async () => {
      const resultcolors = await axios.get("http://localhost:44330/api/Colors/GetAllColors");
    ...
    async function update(e) {
      e.preventDefault();
      await axios.put(`http://localhost:44330/api/ProductColors/UpdateProductColor/${id}`,
        bodyParameters
        // ,{
        //     headers: {

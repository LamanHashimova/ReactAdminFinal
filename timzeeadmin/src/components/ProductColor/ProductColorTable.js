...
function ProductColorTable() {
    ...
    const loadProductColor = async () => {
        ...
        const result = await axios.get(`https://timzeeback.azurewebsites.net/api/ProductColors/GetAllProductColors`)
    ...
    const deleteProductColor = async (id) => {
        debugger
        await axios.delete(`https://timzeeback.azurewebsites.net/api/ProductColors/DeleteProductColor/${id}`)

...
function Sizestable() {
    ...
    const loadSize = async () => {
        ...
        const result = await axios.get(`https://timzeeback.azurewebsites.net/api/Sizes/GetAllSizes`)
    ...
    debugger
        await axios.delete(`https://timzeeback.azurewebsites.net/api/Sizes/DeleteSize/${id}`)

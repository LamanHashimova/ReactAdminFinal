                                ...
                                <div className="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
                                    ...
                                    <div className="list-group">
                                        <a href="#" className="list-group-item">
                                            <div className="row g-0 align-items-center">
                                                <div className="col-2">
                                                    <img src={require(`../../../assets/img/avatars/avatar-5.jpg`)} className="avatar img-fluid rounded-circle" alt="Vanessa Tucker" />
                                                </div>
                                        ...
                                        <a href="#" className="list-group-item">
                                            <div className="row g-0 align-items-center">
                                                <div className="col-2">
                                                    <img src={require(`../../../assets/img/avatars/avatar-2.jpg`)} className="avatar img-fluid rounded-circle" alt="William Harris" />
                                                </div>
                                                <div className="col-10 ps-2">
                                        ...
                                        <a href="#" className="list-group-item">
                                            <div className="row g-0 align-items-center">
                                                <div className="col-2">
                                                    <img src={require(`../../../assets/img/avatars/avatar-4.jpg`)} className="avatar img-fluid rounded-circle" alt="Christina Mason" />
                                                </div>
                                                <div className="col-10 ps-2">
                                        ...
                                        <a href="#" className="list-group-item">
                                            <div className="row g-0 align-items-center">
                                                <div className="col-2">
                                                    <img src={require(`../../../assets/img/avatars/avatar-3.jpg`)} className="avatar img-fluid rounded-circle" alt="Sharon Lessman" />
                                                </div>
                                                <div className="col-10 ps-2">
